...
WHEN após realizar seu trablho, aplica as alterações no sistema e em seu planajemanto
THEN as alterações são realizadas com sucesso
AND a mensagem "Alterações realizadas com sucesso!" aparece na tela
AND o funcionário é direcionado para a tela do mapemaneto atualizado
...
AND analisa esses detalhes, como taxas e reembolsos, dependendo dos casos, detalhados num relatório que preza pela "transparencia"
...
AND o funcionário e cliente é direcionado para a tela do mapemaneto atualizado

#falta analisar e complementar